package OldCode;// OldCode.OnlinePlayer.java
...
public class OnlinePlayer extends Player {
    ...
    /**
     * Used by OldCode.Server to wire up a freshly accepted socket and streams.
     */
    ...
    public void sendMessage(Object msg) {
        if (out != null) {
            try {
                ...
                System.err.println("[OldCode.OnlinePlayer] send error: " + e.getMessage());
            }
        } else {
            // fallback to console
    ...
    public String receiveMessage() {
        if (in != null && out != null) {
            try {
                ...
                System.err.println("[OldCode.OnlinePlayer] receive error: " + e.getMessage());
                return null;
            }
        } else {
